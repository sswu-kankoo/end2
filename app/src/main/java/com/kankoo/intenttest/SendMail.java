...
public class SendMail extends javax.mail.Authenticator {
    ...
    static {
        Security.addProvider(new com.kankoo.intenttest.JSSEProvider());
    }
    ...
    public synchronized void sendMail1(String subject, String body, String sender, String recipients) throws Exception {
        try{
